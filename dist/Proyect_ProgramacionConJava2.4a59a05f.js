...
async function controlRecipes() {
    try {
        ...
        (0, _resultsViewDefault.default).update(_models.getSearchResulstPage());
        (0, _bookmarksViewDefault.default).update(_models.state.bookmarks);
        ...
        (0, _recipeViewDefault.default).render(_models.state.recipe);
    } catch (err) {
        console.error(err);
        alert(err);
    }
...
async function controlSearchResults() {
    try {
        ...
        const query = (0, _searchViewDefault.default).getQuary();
        if (!query) return;
        await _models.loadSearchResults(query);
        (0, _resultsViewDefault.default).render(_models.getSearchResulstPage());
        (0, _paginationViewDefault.default).render(_models.state.search);
    } catch (err) {
        console.error(err);
    }
}
function controlAddBookmark() {
    if (!_models.state.recipe.bookmarked) _models.addBookmark(_models.state.recipe);
    else _models.deletBookmark(_models.state.recipe.id);
    (0, _recipeViewDefault.default).update(_models.state.recipe);
    (0, _bookmarksViewDefault.default).render(_models.state.bookmarks);
}
async function controlAddRecipe(newRecipe) {
    try {
        (0, _addRecipeViewDefault.default).renderSpinner();
        await _models.uploadRecipe(newRecipe);
        console.log(_models.state.recipe);
        (0, _recipeViewDefault.default).render(_models.state.recipe);
...
function controlPagination(pageGoTo) {
    (0, _resultsViewDefault.default).render(_models.getSearchResulstPage(pageGoTo));
    (0, _paginationViewDefault.default).render(_models.state.search);
}
const controlServings = function(newServings) {
    _models.updateServings(newServings);
    (0, _recipeViewDefault.default).update(_models.state.recipe);
};
...
const init = function() {
    ...
    (0, _recipeViewDefault.default).addHandler(controlRecipes);
...
init(); //const arr = ['hashchange', 'load'].forEach((ev)=>{
 // console.log(ev);
 //document.addEventListener(ev, showRecipe());
 //});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/recipeView":"3wx5k","./models":"3JKkD","./config":"2hPh4","./views/searchView":"kbE4Z","./views/resultsView":"kBQ4r","./views/paginationView":"7NIiB","./views/bookmarksView":"1qGeA","./views/addRecipeView":"8AWnP"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
class RecepieView extends (0, _viewDefault.default) {
    ...
    <div class="recipe__quantity">${ing.quantity ? floatAFraccionSimple(ing.quantity) : ''}</div>
...
exports.default = new RecepieView();

},{"./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","c11290a51c3b65b5":"aob6l"}],"2kjY2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const icons = new URL(require("87ee593f9f4c464e")).href;
class view {
    _data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","87ee593f9f4c464e":"aob6l"}],"aob6l":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "getSearchResulstPage", ()=>getSearchResulstPage);
...
const getSearchResulstPage = function(page = state.search.page) {
...
const addBookmark = function(recepie) {
    // add bookmark
...
},{"./config":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/helper":"4wztX"}],"2hPh4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = 'b2773b78-484b-471c-95d0-f62282d51797';
const MODAL_CLOSE_SEC = 5;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4wztX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./previewView":"6tKHS","./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
const icons = new URL(require("728fe66ab2a858af")).href;
...
},{"./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","728fe66ab2a858af":"aob6l"}],"7NIiB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","d937d4480f9ab689":"aob6l"}],"1qGeA":[function(require,module,exports,__globalThis) {
// import icons from 'url:../../img/icons.svg';
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _previewView = require("./previewView");
...
},{"./previewView":"6tKHS","./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["appxp","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")

//# sourceMappingURL=Proyect_ProgramacionConJava2.4a59a05f.js.map
